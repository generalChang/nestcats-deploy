...
__decorate([
    (0, swagger_1.ApiProperty)({
        example: 'rhdrnsckdgh0921@naver.com',
        description: 'email',
        required: true,
    }),
    (0, mongoose_1.Prop)({
...
exports.CatSchema.virtual('comments', {
    ref: 'comments',
    localField: '_id',
    foreignField: 'info',
});
exports.CatSchema.set('toObject', { virtuals: true });
exports.CatSchema.set('toJSON', { virtuals: true });
