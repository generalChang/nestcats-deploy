...
CatsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [cats_service_1.CatsService, cats_repository_1.CatsRepository, customAws_service_1.CustomAwsService],
        exports: [cats_repository_1.CatsRepository, cats_service_1.CatsService],
    })
], CatsModule);
